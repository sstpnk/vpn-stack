...
const messages = { // eslint-disable-line no-unused-vars
  en: {
    ...
    maskingPreset: 'Traffic masking preset',
    serverDefaults: 'Server defaults',
    customMasking: 'Custom H/I parameters',
    initPacketDelay: 'Init packet delay (ms)',
  ...
  ru: {
    maskingPreset: 'Шаблон маскировки трафика',
    serverDefaults: 'Параметры сервера',
    customMasking: 'Свои параметры H/I',
    initPacketDelay: 'Задержка Init-пакета (мс)',
    name: 'Имя',
    password: 'Пароль',
    signIn: 'Войти',
    logout: 'Выйти',
  ...
  chs: {
    maskingPreset: '流量伪装预设',
    serverDefaults: '服务器默认值',
    customMasking: '自定义 H/I 参数',
    initPacketDelay: '初始数据包延迟（毫秒）',
    name: '名称',
    password: '密码',
    signIn: '登录',
    logout: '退出',
